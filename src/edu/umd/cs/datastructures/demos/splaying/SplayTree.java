...
public class SplayTree<T extends Comparable<T>> {
	...
	/*
	 * playing is the chief operation in splay trees. It searches for the node
	 ...
	 * the tree.
	 *
	 * Note that this is a relatively inefficient splay. It's clean and it
	 * depends on tested rotation routines. But it's recursive and it probably
	 * doesn't implement the zig-zag and zig-zig routines as efficiently as they
	 * can be implemented. Fork me, solve it, and show me how it's done through
	 * a Pull Request!
	 */
