...
/**
 * <p>
 * <tt>BinaryPatriciaTrie</tt> is a Patricia Trie over the binary alphabet
 * &#123;0, 1&#124;. By restricting themselves to this small but terrifically
 * useful alphabet, Binary Patricia Tries combine all the positive aspects of
 * Patricia Tries while shedding the storage cost typically associated with
 * Tries that deal with huge alphabets.
 * </p>
 * 
...
public class BinaryPatriciaTrie {
	...
	// You can erase the following line after you erase the exception throwings
	 ...
	 * 
	 * /* To pass our tests, you will need to complete the class' public
	 * interface, declared below. YOU WILL NEED TO COMMENT OUT THE EXCEPTION
	 * THROWINGS, OTHERWISE YOU WILL FAIL ALL TESTS THAT INCLUDE CALLS TO THE
	 * RELEVANT METHODS!
	 */
	 ...
	 * <b>us</b> test your submission thoroughky and it helps <b>you</b> debug
	 * your code!
	 * 
