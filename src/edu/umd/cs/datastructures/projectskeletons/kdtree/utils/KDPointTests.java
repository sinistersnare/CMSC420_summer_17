...
/**
 * <tt>KDPointTests</tt> is a unit testing class for {@link KDPoint}. We just provide these to you (alongside source) to pacify any concerns
 * about whether <tt>KDPoint</tt>s have been thoroughly tested.
